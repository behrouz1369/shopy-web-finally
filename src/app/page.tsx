...
import ArticlesListLastItem from "@/components/home/articlesListLastItem"
...
export default function HomePage() {
    const {data:articlesLast , error} = useSWR({url:`last-articles`},GET)

    if(error){
       notFound()
    }

    const is_loading = !articlesLast && !error
    return (
        <>
             {/* <!-- Hero Section --> */}
             <div className="bg-gradient-to-r from-cyan-500 to-blue-500">
                <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-5 px-8 pt-16">
                    {/* <!-- Descriptions --> */}
                    <div className="flex flex-col items-start gap-3 lg:gap-10 lg:pl-40">
                        <span className="text-sm lg:text-md text-gray-200">بیزینس شما چیست؟</span>
                        <h2 className="text-xl lg:text-5xl text-gray-200 font-bold md:leading-[2.75]">پیام اصلی شما برای فروش محصول</h2>
                        <p className="text-lg lg:text-2xl text-gray-200">متن پایینی شما، نباید بلد باشد و نباید کوتاه، بلکه درست باشد</p>

                        <button className="text-gray-700 font-semibold px-6 py-3 rounded-full bg-white shadow-md hover:underline hover:scale-110 transition-all">دنبال کردن</button>
                    </div>

                    {/* <!-- Banner Hero --> */}
                    <div className="flex-shrink-0">
                        {/* <img className="object-cover" src="./img/hero.png" alt="hero" /> */}
                        <Image
                            src={`/img/hero.png`}
                            alt="hero img"
                            width={500}
                ...
                <div className="max-w-5xl mx-auto mt-20">
                    {/* <!-- Title --> */}
                        <div className="flex justify-center flex-col items-center mb-10">
                            <h2 className="text-3xl md:text-5xl text-gray-800 font-semibold mb-3">آخرین مقالات</h2>
                    ...
                    <div>
                        {
                            ...
                            : (
                                <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                    {articlesLast?.data?.map((article : any) => (
                                        <li
                                            key={article?.id}
                                        ...
                                        <div className="flex flex-1 flex-col items-start">
                                            ...
                                            <div className="p-6 text-start">
                                                ...
                                                <dl className="mt-1 flex flex-grow flex-col justify-between">
                                                    <dd className="text-sm text-gray-500">{article?.published_at}</dd>
                                                </dl>
                                            </div>
                                        </div>
                                        <div>
            ...
            <section className="bg-gray-100 py-32">
                <div className="container mx-auto px-8">
                    ...
                    <div className="max-w-5xl mx-auto mt-20">
                        {/* <!-- Title --> */}
                            <div className="flex justify-center flex-col items-center mb-10">
                                <h2 className="text-3xl md:text-5xl text-gray-800 font-semibold mb-3">سرویس ها</h2>
                                <div className="flex h-1 w-64 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-full"></div>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row items-start mb-20">
                            <div className="flex-1 mb-10 md:mb-0">
                                <h3 className="text-xl md:text-3xl text-gray-700 font-semibold mb-5">لورم ایپسوم متن ساختگی</h3>
                                <p className="text-sm md:text-md w-max-md text-gray-500 leading-7">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
                            </div>

                            <div className="flex-1">
                                <svg className="w-full md:w-5/6 sm:h-64" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path transform="translate(-11.5 -150.75)" d="M119.9,721.42c-3-5.51.4-12.27,4.29-17.18s8.61-10,8.51-16.29c-.15-9-9.7-14.31-17.33-19.09a84,84,0,0,1-15.56-12.51A22.8,22.8,0,0,1,95,650c-1.58-3.52-1.54-7.52-1.44-11.37q.51-19.26,1.91-38.49" fill="none" stroke="#3f3d56" strokeMiterlimit="10" strokeWidth="4"></path>
                                    ...
                                    <path transform="translate(-11.5 -150.75)" d="M387.5,490A66.5,66.5,0,1,1,321,423.5,66.47,66.47,0,0,1,387.5,490Z" fill="none" stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"></path>
                                    <path transform="translate(-11.5 -150.75)" d="M325.38,467.23l8.3,13,35.53,55.59a66.5,66.5,0,0,1-103.32-8.57l43.54-84.94.91,1.43" fill="none" stroke="#f2f2f2" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                                    <path transform="translate(-11.5 -150.75)" d="M385.31,507a66.46,66.46,0,0,1-16.1,28.82l-35.53-55.59,15.69-24.78a.66.66,0,0,1,1.1,0C353.76,460.32,371,486,385.31,507Z" fill="none" stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"></path>
                                    <path transform="translate(-11.5 -150.75)" d="M337.5,452.5a15,15,0,0,1-12.12,14.73l-15-23.51a15,15,0,0,1,27.16,8.78Z" fill="none" stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"></path>
                                    <path transform="translate(-11.5 -150.75)" d="m347.5 481.5" fill="none" stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"></path>
                                    <path transform="translate(-11.5 -150.75)" d="m333.5 480.5" fill="none" stroke="#f2f2f2" strokeMiterlimit="10" strokeWidth="2"></path>
                        ...
                        <div className="flex flex-col md:flex-row items-start">
                            <div className="flex-1 mb-10 md:mb-0">
                                <svg className="w-full md:w-5/6 sm:h-64" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex-1">
                                <h3 className="text-xl md:text-3xl text-gray-700 font-semibold mb-5">لورم ایپسوم متن ساختگی</h3>
                                <p className="text-sm md:text-md max-w-md text-gray-500 leading-7">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            {/* <!-- Cards Section --> */}
            <section className="border-t border-gray-200 py-32 mt-20">
                <div className="container mx-auto px-8">
                    {/* <!-- Title --> */}
                    <div className="flex justify-center flex-col items-center mb-10">
                        <h2 className="text-3xl md:text-5xl text-gray-800 font-semibold mb-3">عنوان</h2>
                        <div className="flex h-1 w-64 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-full"></div>
                    </div>

                    <div className="flex flex-col md:flex-row gap-3">
                        {/* <!-- Card --> */}
                        <div className="flex-1 border-2 border-gray-300 rounded p-5">
                            <span className="text-[14px] text-gray-500">لورم ایپسوم متن ساختگی</span>
                            <h4 className="text-lg md:text-xl text-gray-800 font-semibold mb-3">لورم ایپسوم متن ساختگی</h4>
                            <p className="text-sm text-gray-700">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
                            <div className="flex justify-end py-2">
                                <button className="text-white px-6 py-3 rounded-full bg-blue-500 hover:underline hover:scale-110 transition-all">لینک</button>
                            </div>
                        </div>
            ...
            {/* <!-- Prices Section --> */}
            <section className="bg-gray-100 border-t border-gray-200 py-32">
                <div className="container mx-auto px-8">
                    {/* <!-- Title --> */}
                    <div className="flex justify-center flex-col items-center mb-20">
                        <h2 className="text-3xl md:text-5xl text-gray-800 font-semibold mb-3">قیمت ها</h2>
                        <div className="flex h-1 w-64 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-full"></div>
                    </div>

                    <div className="flex flex-col md:flex-row md:items-end gap-4 md:gap-0">
                        {/* <!-- Price Box --> */}
                        <div className="flex-1 rounded overflow-hidden shadow-md shadow-gray-300 border border-gray-200 bg-white">
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col justify-center items-center">
                                    <h4 className="text-3xl text-gray-800 font-bold py-5">رایگان</h4>

                                    <div className="flex h-1 w-full bg-gray-200 rounded-t-full"></div>
                                </div>
                                <ul className="flex flex-col">
                                    <li className="flex justify-center text-sm text-gray-500 text-center py-3 border-b border-gray-200">ویژگی</li>
                                    <li className="flex justify-center text-sm text-gray-500 text-center py-3 border-b border-gray-200">ویژگی</li>
                                    <li className="flex justify-center text-sm text-gray-500 text-center py-3 border-b border-gray-200">ویژگی</li>
                                </ul>
                                ...
                                <div className="flex flex-col justify-center items-center gap-3 py-5">
                                    <p className="text-sm text-gray-600">
                                        به ازای هر کاربر
                                        /
                                        <span className="text-3xl text-gray-700 font-bold">0 تومان</span>
                                    </p>

                                    <button className="text-white px-6 py-3 rounded-full bg-blue-500 hover:underline hover:scale-110 transition-all">عضویت</button>
                                </div>
                            </div>
                        </div>

                        {/* <!-- Price Box --> */}
                        <div className="flex-1 rounded overflow-hidden shadow-md shadow-gray-400 border border-gray-200 bg-white md:scale-x-110">
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col justify-center items-center">
                                    <h4 className="text-3xl text-gray-800 font-bold py-5">رایگان</h4>

                                    <div className="flex h-1 w-full bg-gradient-to-r from-cyan-500 to-blue-500 rounded-t-full"></div>
                                </div>
                                <ul className="flex flex-col">
                                    <li className="flex justify-center text-md text-gray-700 font-semibold text-center py-3 border-b border-gray-200">ویژگی</li>
                                    <li className="flex justify-center text-md text-gray-700 font-semibold text-center py-3 border-b border-gray-200">ویژگی</li>
                                    <li className="flex justify-center text-md text-gray-700 font-semibold text-center py-3 border-b border-gray-200">ویژگی</li>
                                    <li className="flex justify-center text-md text-gray-700 font-semibold text-center py-3 border-b border-gray-200">ویژگی</li>
                                </ul>
                                ...
                                <div className="flex flex-col justify-center items-center gap-3 py-5">
                                    <p className="text-sm text-gray-700 font-semibold">
                                        به ازای هر کاربر
                                        /
                                        <span className="text-3xl text-gray-700 font-bold">20 تومان</span>
                                    </p>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex flex-col justify-center items-center gap-3 py-5">
                                    <p className="text-sm text-gray-600">
                                        به ازای هر کاربر
                                        /
                                        <span className="text-3xl text-gray-700 font-bold">40 تومان</span>
                                    </p>
            ...
            {/* <!-- Prices Section --> */}
            <section className="bg-gradient-to-r from-cyan-500 to-blue-500 pb-32">
                <div>
                    <svg className="" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg">//xmlns:xlink="http://www.w3.org/1999/xlink"
                        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                ...
                <div className="container mx-auto px-8 pt-20">
                    ...
                    <div className="flex justify-center flex-col items-center gap-4 mb-10">
                        <h2 className="text-3xl md:text-5xl text-gray-200 font-semibold mb-3">فراخوانی برای اقدام</h2>
                        <div className="bg-white h-1 w-64 rounded-t-full opacity-[.35]"></div>
                        <p className="text-xl md:text-3xl text-gray-200 font-[500] mb-3">این پیام برای شما تا اقدام کنید!</p>
                    </div>

                    <div className="flex justify-center">


                        <button className="text-gray-700 font-semibold px-8 py-4 rounded-full bg-white shadow-md hover:underline hover:scale-110 transition-all">دکمه!</button>
